...
<head>
    ...
    <link rel="stylesheet" href="dashboard/vendors/daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="dashboard/vendors/chartist/chartist.min.css">
            ...
            <ul class="navbar-nav navbar-nav-right ml-auto">
                ...
                <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                    <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                        <img class="img-xs rounded-circle ml-2" src="dashboard/images/faces/face8.jpg" alt="Profile image"> <span class="font-weight-normal"> Henry Klein </span></a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive border rounded p-1">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="img-sm rounded-circle" src="dashboard/images/faces/face1.jpg" alt="profile image"> Katie Holmes </td>
                                            <td>$3621</td>
                                            <td><img src="dashboard/images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                                            <td>04 Jun 2019</td>
                                            <td>18 Jul 2019</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>$6245</td>
                                            <td><img src="dashboard/images/dashboard/paypal.png" alt="alipay" class="gateway-icon mr-2"> Paypal</td>
                                            <td>25 Sep 2019</td>
                                            <td>07 Oct 2019</td>
                                            <td>
