...
<head>
    ...
    <link rel="stylesheet" href="style/vendors/select2/select2.min.css">
    <link rel="stylesheet" href="style/vendors/select2-bootstrap-theme/select2-bootstrap.min.css">
...
<div class="container-scroller">
            ...
            <ul class="navbar-nav navbar-nav-right ml-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="style/images/faces/face10.jpg" alt="image" class="img-sm profile-pic">
                            </div>
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="style/images/faces/face12.jpg" alt="image" class="img-sm profile-pic">
                            </div>
                            <div class="preview-item-content flex-grow py-2">
                        ...
                        <a class="dropdown-item preview-item">
                            <div class="preview-thumbnail">
                                <img src="style/images/faces/face1.jpg" alt="image" class="img-sm profile-pic">
                            </div>
                            <div class="preview-item-content flex-grow py-2">
                ...
                <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                    <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown"
                       aria-expanded="false">
                        <img class="img-xs rounded-circle ml-2" src="style/images/faces/face8.jpg"
                             alt="Profile image"> <span class="font-weight-normal"> Henry Klein </span></a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        <div class="dropdown-header text-center">
                            <img class="img-md rounded-circle" src="style/images/faces/face8.jpg"
                                 alt="Profile image">
                ...
                <li class="nav-item nav-profile">
                    <a href="#" class="nav-link">
                        <div class="profile-image">
                            <img class="img-xs rounded-circle" src="style/images/faces/face8.jpg"
                                 alt="profile image">
    ...
    <script src="style/vendors/select2/select2.min.js"></script>
    <script src="style/vendors/typeahead.js/typeahead.bundle.min.js"></script>
