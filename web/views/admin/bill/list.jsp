...
<div class="container-scroller">
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
            <a class="navbar-brand brand-logo" href="/bills">
                <img src="resources/images/logo.svg" alt="logo" class="logo-dark"/>
            </a>
            <a class="navbar-brand brand-logo-mini" href="/bills"><img src="resources/images/logo-mini.svg" alt="logo"/></a>
        </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="/bills?action=list">Bill List</a></li>
                            <li class="nav-item"><a class="nav-link" href="/bills?action=create">Bill Create</a></li>
                        </ul>
                    </div>
                </li>
                                    ...
                                    <table class="table">
                                        ...
                                        <c:forEach var="bill" items="${listBill}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/bill?action=edit">Edit</a>
