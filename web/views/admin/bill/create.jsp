...
<div class="container-scroller">
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
            ...
            <a class="navbar-brand brand-logo-mini" href="/views/admin/bill/list.jsp"><img src="resources/images/logo-mini.svg" alt="logo" /></a>
        </div>
    ...
    <div class="container-fluid page-body-wrapper">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/views/admin/bill/list.jsp">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="/views/admin/bill/list.jsp">Bill List</a></li>
                            <li class="nav-item"> <a class="nav-link" href="/views/admin/bill/create.jsp">Bill Create</a></li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="main-panel">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample">
                                    ...
                                    <div class="form-group">
                                        <label >Shipping_fee</label>
                                        <input type="text" class="form-control" id="shipping_fee" name="shipping_fee" placeholder="shipping_fee">
                                    </div>
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright ©  <a href="https://www.bootstrapdash.com/" target="_blank">Bootstrap Dash</a>. All rights reserved.</span>
